import argparse
from horse2zebra import horse2zebra_datasets
from PlainGANSolver import Solver
...
if __name__ == '__main__':
    ...
    parser.add_argument('--separate_G', type=str2bool, default=False) # Only for GcGAN

    # training hyperparameters
    parser.add_argument('--max_imgs', type=int, default=None)
    parser.add_argument('--niter', type=int, default=4000)
    parser.add_argument('--niter_decay', type=int, default=4000)
    ...
    # misc
    parser.add_argument('--has_labels', type=str2bool, default=False)
    parser.add_argument('--begin_train', type=str2bool, default=False)
    parser.add_argument('--geometry', type=int, default=2) # 0:identity, 1:rot90, 2:rot180, 3:vf, 4:gauss_noise, 5:rot90+noise, 6:rot180+noise
    ...
    if config.lambda_gc == 0 and config.lambda_cycle == 0:
        ...
        from GcGANSolver import Solver
