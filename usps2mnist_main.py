import argparse
from usps2mnist import usps2mnist_datasets
import os
...
if __name__ == '__main__':
    ...
    # misc
    parser.add_argument('--has_labels', type=str2bool, default=True)
    ...
    usps_loader, mnist_loader = usps2mnist_datasets.get_loaders(config)
    ...
    solver = Solver(config, usps_loader, mnist_loader)
